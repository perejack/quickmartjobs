  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 bg-gradient-to-br from-blue-50 to-green-50 rounded-3xl shadow-2xl p-8 max-w-lg w-full flex flex-col items-center animate-fade-in-up">
        ...
        <div className="text-lg text-gray-700 mb-4 text-center">A <span className="font-bold text-green-600">refundable onboarding application fee</span> of <span className="font-bold text-blue-700">350 Ksh</span> will be paid.</div>
